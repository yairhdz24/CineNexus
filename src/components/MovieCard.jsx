...
// Descripción: Tarjeta de película con efectos 3D
// ============================================
    ...
    return (
        ...
        <Link to={`/movie/${movie.imdbID}`}>
            ...
            >
                ...
                <div className="absolute -inset-0.5 bg-gradient-to-r from-violet-600 via-pink-600 to-cyan-600 rounded-2xl opacity-0 group-hover:opacity-75 blur-lg transition-opacity duration-500 -z-10" />

                {/* Contenedor principal del card */}
                <div className="relative bg-white dark:bg-slate-800 rounded-2xl overflow-hidden shadow-lg group-hover:shadow-2xl transition-all duration-500 border border-white/20 dark:border-slate-700/50 h-full flex flex-col">
                    ...
                    <div className="block relative aspect-[2/3] overflow-hidden">
                        ...
                        <div className="absolute top-2 left-2 z-10 flex gap-1">
                            ...
                            <span className="px-2 py-1 bg-yellow-500 text-black text-xs font-bold rounded shadow-lg flex items-center gap-1">
                        ...
                        {hasPoster && !imageError ? (
                            <>
                                ...
                                <div className="absolute inset-0 bg-gradient-to-tr from-transparent via-white/10 to-transparent opacity-0 group-hover:opacity-100 translate-x-[-100%] group-hover:translate-x-[100%] transition-all duration-1000" />
                            </>
                        ) : (
                            ...
                            <div className="w-full h-full flex flex-col items-center justify-center bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 dark:from-slate-950 dark:via-slate-900 dark:to-slate-950">
                                <img
                                    src={logoDark}
                                    alt="CineNexus"
                                    className="w-32 h-auto mb-4 opacity-50"
                                />
                                <p className="text-white/60 text-sm font-semibold">Sin Póster</p>
                            </div>
                        )}
                    ...
                    <div className="p-4 flex-1 flex flex-col">
                        ...
                        <div className="flex items-center gap-2 mt-2 text-xs">
                            ...
                            <span className={`
                                inline-flex items-center gap-1 px-2 py-0.5 rounded-full text-xs font-semibold text-white shadow-lg
                        ...
                        <div className="mt-3 w-full inline-flex items-center justify-center gap-2 px-4 py-2.5 bg-gradient-to-r from-violet-600 to-purple-600 group-hover:from-violet-500 group-hover:to-purple-500 text-white text-xs font-semibold rounded-full transition-all shadow-lg group-hover:shadow-xl group-hover:shadow-violet-500/50 transform group-hover:scale-105">
                            <Info size={14} />
                            Ver Detalles
                        </div>
                    </div>
